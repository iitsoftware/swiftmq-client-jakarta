 ...
 * - Connection Factory to lookup [ConnectionFactory]
...
public class P2PRequestor
{
	public static void main(String[] args)
	{
		...
		String qcfName = "ConnectionFactory";
		...
		try {
			...
			jakarta.jms.Queue queue = (jakarta.jms.Queue)ctx.lookup(queueName);
			...
			// We don't use the jakarta.jms.QueueRequestor because it is bad designed.
